...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/lixiaoqiang/myFramework'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'lixiaoqiang' => 'lxq268850@alibaba-inc.com' }
  s.source           = { :git => 'https://github.com/lixiaoqiang/myFramework.git', :tag => s.version.to_s }
